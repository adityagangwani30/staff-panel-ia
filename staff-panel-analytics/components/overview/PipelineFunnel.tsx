        ...
        {stages.map((stage, idx) => {
          ...
          return (
            <div key={idx} className="flex items-center gap-3">
              ...
              {/* Funnel Track */}
              <div className="flex-1 h-9.5 bg-slate-950/60 rounded-lg overflow-hidden border border-slate-800/40 relative flex items-center">
                {/* Colored Fill */}
                <div 
                  className="h-full rounded-r transition-all duration-500 ease-out flex items-center justify-end px-3 font-mono text-xs font-bold text-slate-950"
                  style={{ 
